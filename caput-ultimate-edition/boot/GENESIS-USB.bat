...
echo [96m═══════════════════════════════════════════════════════════════[0m
echo.
echo [92m  Owner: CAPUT Admin (admin@caput.system)[0m
...
:: Set environment
set "GENESIS_OWNER_ID=admin@caput.system"
set "GENESIS_OWNER_NAME=CAPUT Admin"
...
if %errorlevel% neq 0 (
    ...
    if exist "%GENESIS_ROOT%..\caput-ultimate-edition\static\index.html" (
        start "" "%GENESIS_ROOT%..\caput-ultimate-edition\static\index.html"
    )
    goto :end
)
...
:: Navigate to app
cd /d "%GENESIS_ROOT%..\caput-ultimate-edition"
