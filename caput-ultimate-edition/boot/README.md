...
2. **Copy files to USB:**
   ...
   │   ├── genesis-boot.conf
   │   └── genesis-init.sh
   ├── caput-ultimate-edition/    ← entire folder
...
- **Admin Exclusive:** Only CAPUT Admin has admin rights
...
2. Check logs: `caput-ultimate-edition/data/logs/`
3. Run manually: `cd caput-ultimate-edition && npm start`
