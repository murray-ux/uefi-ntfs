...
export GENESIS_KEY_DIR="${GENESIS_ROOT}/caput-ultimate-edition/data/keys"
export GENESIS_AUDIT_DIR="${GENESIS_ROOT}/caput-ultimate-edition/data/audit"
export GENESIS_EVIDENCE_DIR="${GENESIS_ROOT}/caput-ultimate-edition/data/evidence"
...
if ! command -v node &> /dev/null; then
    ...
    if command -v xdg-open &> /dev/null; then
        xdg-open "${GENESIS_ROOT}/caput-ultimate-edition/static/index.html" 2>/dev/null || true
    elif command -v open &> /dev/null; then
        open "${GENESIS_ROOT}/caput-ultimate-edition/static/index.html" 2>/dev/null || true
    fi
    exit 1
fi
