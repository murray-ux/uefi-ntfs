...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  async getWifiNetworks(): Promise<WifiNetwork[]> {
    ...
    return [
      { ssid: "Bembrick-5G", band: "5GHz", channel: 149, security: "WPA3", enabled: true, guestNetwork: false },
      { ssid: "Bembrick-2.4G", band: "2.4GHz", channel: 6, security: "WPA2", enabled: true, guestNetwork: false },
      { ssid: "Bembrick-Guest", band: "2.4GHz", channel: 6, security: "WPA2", enabled: false, guestNetwork: true },
    ];
  }
