...
if [ -d "${GENESIS_ROOT}/bembrick-ultimate-edition" ]; then
    ...
    if command -v node &> /dev/null; then
        ...
        echo -e "${YELLOW}[GENESIS]${NC} Static dashboard available at: ${GENESIS_ROOT}/bembrick-ultimate-edition/static/index.html"
    fi
fi
